...
export const SetVariables: classCommentType[] = [{
  ...
  description: "This contains the field definition of the SetVariablesRequest PDU sent by the CSMS to the Charging Station.",
  fields: [{
  ...
  description: "This contains the field definition of the SetVariablesResponse PDU sent by the Charging Station to the CSMS in response to a SetVariablesRequest.",
  fields: [{
