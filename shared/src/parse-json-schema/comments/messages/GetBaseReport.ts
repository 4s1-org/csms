...
export const GetBaseReport: classCommentType[] = [{
  ...
  description: "This contains the field definition of the GetBaseReportRequest PDU sent by the CSMS to the Charging Station.",
  fields: [{
    fieldName: "requestId",
    fieldType: "integer",
    cardinality: "1..1",
  ...
  description: "This contains the field definition of the GetBaseReportResponse PDU sent by the Charging Station to the CSMS.",
  fields: [{
    fieldName: "status",
