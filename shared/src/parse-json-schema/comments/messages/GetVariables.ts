...
export const GetVariables: classCommentType[] = [{
  ...
  description: "This contains the field definition of the GetVariablesRequest PDU sent by the CSMS to the Charging Station.",
  fields: [{
  ...
  description: "This contains the field definition of the GetVariablesResponse PDU sent by the CSMS to the Charging Station in response to GetVariablesRequest.",
  fields: [{
