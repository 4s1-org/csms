...
export const ConnectorStatusEnumType: enumCommentType = {
  ...
  description: "A status can be reported for the Connector of an EVSE of a Charging Station. States considered Operative are: Available, Reserved and Occupied. States considered Inoperative are: Unavailable, Faulted.",
  values: [{
    value: "Available",
    ...
    value: "Faulted",
    description: "When a Connector (or the EVSE or the entire Charging Station it belongs to) has reported an error and is not available for energy delivery. (Inoperative)."
  }]
}
