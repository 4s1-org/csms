...
export const ResetStatusEnumType: enumCommentType = {
  ...
  values: [{
    ...
    value: "Scheduled",
    description: "Reset command is scheduled, Charging Station is busy with a process that cannot be interrupted at the moment. Reset will be executed when process is finished."
  }]
}
